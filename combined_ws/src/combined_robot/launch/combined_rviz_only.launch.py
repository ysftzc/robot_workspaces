"""Launch the Panther + FR3 model in RViz only.

This starts no Gazebo, no ros2_control, and no joint-state GUI.  It is intended
for clean report screenshots of the URDF model and mounted sensors.
"""
