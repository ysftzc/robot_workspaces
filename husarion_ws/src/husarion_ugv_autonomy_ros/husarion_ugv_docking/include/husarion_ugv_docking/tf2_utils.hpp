 ...
 *  This function transforms a pose to a target frame using the provided tf2
 * buffer.
 *
 ...
 * Roll is rotation around the X axis. Pitch is rotation around the Y axis. Yaw
 * is rotation around the Z axis.
 *
 ...
 * This function checks if two poses are near each other on the XY plane within
 * a given distance and angle tolerance.
 *
