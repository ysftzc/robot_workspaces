...
- Include the [ANT02](https://github.com/husarion/husarion_components_description/blob/ros2/urdf/teltonika_003R-00253.urdf.xacro) by adding the following lines to your [components.yaml](../husarion_ugv_description/config/components.yaml) file inside the `components` list:
